 ...
 *     if (thisperson != null) {
 *         Debug.instance.traceMsg("two name is "+thisperson.name);
 *         Debug.instance.traceMsg("two age is "+thisperson.age);
 *         Debug.instance.traceMsg("two sex is "+thisperson.sex);
 *     }else{
 *         Debug.instance.traceMsg("two is not in friends!");
 *     }
 * </listing>
 *</p>
 * @author iiley
...
public class HashMap
{
    ...
    private var content:Dictionary;
 	...
 	public function HashMap(weak:Boolean=true){
        length = 0;
		content = new Dictionary(weak);
        //content = new Dictionary(true);
 	}
