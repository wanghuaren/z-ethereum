...
//			                        diagram.setPixel32(0, diagramHeight * (1 - _loc_5), 0xffff6600);
		...
		                private function onResize(e:Event = null):void {
			...
			                        var _point:Point = parent.globalToLocal(pt);//stage.stageWidth 
			                        this.x = _point.x;
			                        this.y = _point.y;
		                }
		
								//临时增加显示舞台显示对象个数
//								private function countDisplayList(container:DisplayObjectContainer):int {
//									var childrenCount:int = container.numChildren;
//									for (var i:int=container.numChildren-1; i >=0; i--) {
//										var dobjC:DisplayObjectContainer = container.getChildAt(i) as DisplayObjectContainer;
//										if (dobjC!=null) {
//											childrenCount += countDisplayList(dobjC);
//										}
//									}
