package nets.packets
{
    ...
    import netc.packets2.StructBeatBackInfo2
    import netc.packets2.StructContinuousKillInfo2
    ...
    *角色数据内存信息
    */
    public class StructRoleMemInfo implements ISerializable
    {
        /** 
        *账号ID
        */
        ...
        *反击列表
        */
        public var arrItembeatbacklist:Vector.<StructBeatBackInfo2> = new Vector.<StructBeatBackInfo2>();
        /** 
        *连斩数据
        */
        public var continuouskill:StructContinuousKillInfo2 = new StructContinuousKillInfo2();
        /** 
        *GM等级
        */
        ...
        *上次任务追踪数据
        */
        public var arrItemlast_tasktrack_result:Vector.<int> = new Vector.<int>();
        /** 
        *宝石信息
        */
        ...
        */
        ...
        public function Serialize(ar:ByteArray):void
        {
            ...
            ar.writeInt(arrItembeatbacklist.length);
            for each (var beatbacklistitem:Object in arrItembeatbacklist)
            {
                var objbeatbacklist:ISerializable = beatbacklistitem as ISerializable;
                if (null!=objbeatbacklist)
                {
                    objbeatbacklist.Serialize(ar);
                }
            }
            continuouskill.Serialize(ar);
            ar.writeInt(gmpower);
            ar.writeInt(cantsay);
            impact.Serialize(ar);
            client.Serialize(ar);
            ...
            ar.writeInt(arrItemlast_tasktrack_result.length);
            for each (var last_tasktrack_resultitem:int in arrItemlast_tasktrack_result)
            {
                ar.writeInt(last_tasktrack_resultitem);
            }
        ...
        public function Deserialize(ar:ByteArray):void
        {
            ...
            arrItembeatbacklist= new  Vector.<StructBeatBackInfo2>();
            var beatbacklistLength:int = ar.readInt();
            for (var ibeatbacklist:int=0;ibeatbacklist<beatbacklistLength; ++ibeatbacklist)
            {
                var objBeatBackInfo:StructBeatBackInfo2 = new StructBeatBackInfo2();
                objBeatBackInfo.Deserialize(ar);
                arrItembeatbacklist.push(objBeatBackInfo);
            }
            continuouskill.Deserialize(ar);
            gmpower = ar.readInt();
            cantsay = ar.readInt();
            ...
            arrItemlast_tasktrack_result= new  Vector.<int>();
            var last_tasktrack_resultLength:int = ar.readInt();
            for (var ilast_tasktrack_result:int=0;ilast_tasktrack_result<last_tasktrack_resultLength; ++ilast_tasktrack_result)
            {
                arrItemlast_tasktrack_result.push(ar.readInt());
            }
