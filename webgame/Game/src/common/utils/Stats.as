package common.utils
{
	...
	public class Stats extends Sprite
	{
		...
		private static var m_instance:Stats=null;

		//表示是否开启Log信息
		public static var IS_OPEN_LOG:Boolean=true;

		protected const WIDTH:uint=260;
		...
		public function Stats():void
		{
			...
			txtlog.selectable=true;
			txtlog.border=true;
			txtlog.textColor=0xfff5d2;
			txtlog.borderColor=0xfff5d2;
			txtlog.multiline=true;
			txtlog.width=WIDTH;
			txtlog.height=HEIGHT * 3;
			txtlog.x=0;
			txtlog.y=HEIGHT;
		...
		{
			IS_OPEN_LOG=true;
//			txtlog.text=Monitor.instance.SYSINFO;

			graphics.beginFill(colors.bg, 0.9);
			...
			GameClock.instance.addEventListener(WorldEvent.CLOCK__, update);
		}
		...
		private function destroy(e:Event):void
		{
			...
			GameClock.instance.removeEventListener(WorldEvent.CLOCK__, update);
		}
		...
		public function addLog(s:String):void
		{
			...
			var _addString:String="[" + _date.toLocaleTimeString() + "] " + s + "\n";

			txtlog.appendText(_addString);
