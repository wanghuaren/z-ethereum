package scene.action
{
	...
	public class Boss41EffectAction
	{		
		
		public function Boss41EffectAction()
		{
		...
		/**
		 */ 
		public function BuffUpdate(objid:uint,hasBoss4:Boolean,KP:King=null):void
		{
			var k:IGameKing;
			...
			{				
				...
				{
					if("boss4_effect1" == (d as SkillEffect12).path)
					{
						hasEffect = true;
						break;
					}
			...
			if(hasBoss4)
			{
				...
				{				
					...
					se_boss2.setData(k.objid,"boss4_effect1");
