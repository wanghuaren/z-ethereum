package scene.action
{
	...
	public class Boss3EffectAction
	{		
		
		public function Boss3EffectAction()
		{
		...
		/**
		 */ 
		public function BuffUpdate(objid:uint,hasBoss3:Boolean,KP:King=null):void
		{
			var k:IGameKing;
			...
			{				
				...
				{
					if("boss3_effect" == (d as SkillEffect12).path)
					{
						hasEffect = true;
						break;
					}
			...
			if(hasBoss3)
			{
				...
				{				
					...
					se_boss2.setData(k.objid,"boss3_effect");
