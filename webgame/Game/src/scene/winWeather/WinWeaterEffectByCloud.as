package scene.winWeather
{
	...
	public class WinWeaterEffectByCloud extends UIWindow
	{
		
		private static var _instance:WinWeaterEffectByCloud;
		
		public static function getInstance():WinWeaterEffectByCloud
		{
			if (null == _instance)
			{
				_instance=new WinWeaterEffectByCloud();
			}
		...
		public const MIN_NEED_CLOUD_LIST_COL:int = 4;//2;
		public const MIN_NEED_CLOUD_LIST_ROW:int = 3;//2;
		 ...
		 * 美术元件 云 宽高
		 */ 
		public const CLOUD_WIDTH:int = 1000;//1024;
		public const CLOUD_HEIGHT:int = 320;
		...
		public function WinWeaterEffectByCloud()
		{
		...
		public function getDisplayContent():DisplayObject
		{
			...
			bfp = FileManager.instance.getSkill12FileByFileName("yjf_cloud");
