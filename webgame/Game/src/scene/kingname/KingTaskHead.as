package scene.kingname
{
	...
	public class KingTaskHead extends Sprite
	{ 
		private var _v:MovieClip;
		
		public function KingTaskHead()
		{
		}
		...
		public function get v():MovieClip
		{
			if(null == _v)
			{
//项目转换				_v = ResTool.getAppMc("TaskHead") as MovieClip;
				_v = GamelibS.getswflink("game_index","TaskHead") as MovieClip;
