package scene.kingname
{
	...
	public class KingTeamFlagHead extends Sprite
	{
		private var _v:MovieClip;
		
		public function KingTeamFlagHead()
		{
		}
		...
		public function get v():MovieClip
		{
			if(null == _v)
			{
//项目转换				_v = ResTool.getAppMc("TeamFlagHead") as MovieClip;
				_v =GamelibS.getswflink("game_index","TeamFlagHead") as MovieClip;
