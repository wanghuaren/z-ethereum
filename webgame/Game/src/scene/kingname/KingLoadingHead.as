package scene.kingname
{
	...
	public class KingLoadingHead extends Sprite
	{
		private var _v:MovieClip;
				
		public function KingLoadingHead()
		{
		}
		...
		public function get v():MovieClip
		{
			if(null == _v)
			{
//项目转换				_v = ResTool.getAppMc("Head_Loading") as MovieClip;
				_v = GamelibS.getswflink("game_index","Head_Loading") as MovieClip;
