package scene.kingname
{
	...
	public class KingShopHead extends Sprite
	{
		private var _v:MovieClip;
		
		public function KingShopHead()
		{
		}
		...
		public function get v():MovieClip
		{
			if(null == _v)
			{
//项目转换				_v = ResTool.getAppMc("ShopHead") as MovieClip;
_v = GamelibS.getswflink("game_index","ShopHead") as MovieClip;
