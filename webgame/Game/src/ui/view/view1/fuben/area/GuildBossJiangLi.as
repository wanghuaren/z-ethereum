package ui.view.view1.fuben.area
{
	...
	public class GuildBossJiangLi  extends UIWindow
	{
		...
		public function GuildBossJiangLi(value:Vector.<StructIntParamList2>,_callbacktype:int)
		{
			sipl=value;
		...
		private static var _instance:GuildBossJiangLi=null;
		
		public static function instance(value:Vector.<StructIntParamList2>,_callbacktype:int):GuildBossJiangLi
		{
			if (null == _instance)
			{
				_instance=new GuildBossJiangLi(value,_callbacktype);
			}
			else
			{
				sipl=value;
...
//			失败  挑战失败
			...
			//第一个是金币，第二个声望，无经验 		
			//mc["txtExpName"].text = "银两";
			//mc["txtCoinName"].text = "声望";
...
//			sprite["uil"].source=itemData.iconBig;
		...
		{
			GuildBossJiangLi.instance(_sipl,_callbacktype).open();
		}
