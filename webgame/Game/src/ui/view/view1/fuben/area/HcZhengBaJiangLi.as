package ui.view.view1.fuben.area
{
	...
	public class HcZhengBaJiangLi  extends UIWindow
	{
		...
		public function HcZhengBaJiangLi(value:Vector.<StructIntParamList2>,_callbacktype:int)
		{
			sipl=value;
		...
		private static var _instance:HcZhengBaJiangLi=null;
		
		public static function instance(value:Vector.<StructIntParamList2>,_callbacktype:int):HcZhengBaJiangLi
		{
			if (null == _instance)
			{
				_instance=new HcZhengBaJiangLi(value,_callbacktype);
			}
			else
			{
				sipl=value;
...
//			sprite["uil"].source=itemData.iconBig;
		...
		{
			HcZhengBaJiangLi.instance(_sipl,_callbacktype).open();
		}
