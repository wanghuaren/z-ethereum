package ui.view.view1.fuben.area
{
	...
	public class OneKeyCleanJiangLi  extends UIWindow
	{
		...
		public function OneKeyCleanJiangLi(value:Vector.<StructIntParamList2>,_callbacktype:int)
		{
			sipl=value;
		...
		private static var _instance:OneKeyCleanJiangLi=null;
		
		public static function instance(value:Vector.<StructIntParamList2>,_callbacktype:int):OneKeyCleanJiangLi
		{
			if (null == _instance)
			{
				_instance=new OneKeyCleanJiangLi(value,_callbacktype);
			}
			else
			{
				sipl=value;
...
//			失败  挑战失败
			...
			//coin
			//mc["fbjl"]["txtCoin"].text = sipl[0].intparam.toString();
			//mc["fbjl"]["txtExp"].text = sipl[0].intparam.toString();	
			mc["fbjl"]["txtExp"].text = sipl[0].intparam.toString();		
			
			//mc["fbjl"]["txtRenown"].text =  sipl[1].intparam.toString();
			mc["fbjl"]["txtCoin"].text = sipl[1].intparam.toString();
...
//			sprite["uil"].source=itemData.iconBig;
		...
		private function reset():void
		{
			...
			for(k=1;k<=1;k++)
			{
				var dc:DisplayObjectContainer = mc["jiangli" + k.toString()];
		...
		{
			OneKeyCleanJiangLi.instance(_sipl,_callbacktype).open();
		}
