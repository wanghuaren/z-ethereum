package ui.view.view1.fuben.area
{
	...
	public class XuanHuangJiangLi extends UIWindow
	{
		private static var sipl:Vector.<StructIntParamList2>;
		private static var callbacktype:int;
		private var daoJiShi:int;
		
		public function XuanHuangJiangLi(value:Vector.<StructIntParamList2>,_callbacktype:int)
		{
			sipl = value;
		...
		private static var _instance : XuanHuangJiangLi = null;
				
		public static function instance(value:Vector.<StructIntParamList2>,_callbacktype:int) : XuanHuangJiangLi{
			if (null == _instance)
			{
				_instance=new XuanHuangJiangLi(value,_callbacktype);
			}
			else
			{
				sipl = value;
		...
		public function daoJiShiHandler(e:WorldEvent):void
		{
			...
			if(daoJiShi == 55)
			{
				TweenLite.to(mc['mc_tong_guan'],1.0,{
					
					alpha:0.0,
					onComplete:hide_mc_tong_guan
				});
...
//			sprite["uil"].source=itemData.iconBig;
		...
		override public function mcHandler(target:Object):void
		{
			...
			if (target.name == "bx" || target.name == "bx1")
			{
				...
				//test
				/*var result_scp:PacketSCCallBack2 = new PacketSCCallBack2();
				result_scp.arrItemcharparam = new Vector.<StructCharParamList2>();
				result_scp.arrItemintparam = new Vector.<StructIntParamList2>();
				
				var scp_0:StructIntParamList2 = new StructIntParamList2();
				scp_0.intparam = 10403017;
				
				var scp_1:StructIntParamList2 = new StructIntParamList2();
				scp_1.intparam = 1;
				
				var scp_2:StructIntParamList2 = new StructIntParamList2();
				scp_2.intparam = 10300003;
				
				var scp_3:StructIntParamList2 = new StructIntParamList2();
				scp_3.intparam = 3;
				
				var scp_4:StructIntParamList2 = new StructIntParamList2();
				scp_4.intparam = 19790115;
				
				var scp_5:StructIntParamList2 = new StructIntParamList2();
				scp_5.intparam = 10403018;
				
				var scp_6:StructIntParamList2 = new StructIntParamList2();
				scp_6.intparam = 1;
				
				var scp_7:StructIntParamList2 = new StructIntParamList2();
				scp_7.intparam = 10300003;
				
				var scp_8:StructIntParamList2 = new StructIntParamList2();
				scp_8.intparam = 4;
				
				var scp_9:StructIntParamList2 = new StructIntParamList2();
				scp_9.intparam = 19790115;
				
				var scp_10:StructIntParamList2 = new StructIntParamList2();
				scp_10.intparam = 10403017;
				
				var scp_11:StructIntParamList2 = new StructIntParamList2();
				scp_11.intparam = 1;
				
				var scp_12:StructIntParamList2 = new StructIntParamList2();
				scp_12.intparam = 10300003;
				
				var scp_13:StructIntParamList2 = new StructIntParamList2();
				scp_13.intparam = 3;
				
				result_scp.arrItemintparam.push(scp_0);
				result_scp.arrItemintparam.push(scp_1);
				result_scp.arrItemintparam.push(scp_2);
				result_scp.arrItemintparam.push(scp_3);
				result_scp.arrItemintparam.push(scp_4);
				result_scp.arrItemintparam.push(scp_5);
				result_scp.arrItemintparam.push(scp_6);
				result_scp.arrItemintparam.push(scp_7);
				result_scp.arrItemintparam.push(scp_8);
				result_scp.arrItemintparam.push(scp_9);
				result_scp.arrItemintparam.push(scp_10);
				result_scp.arrItemintparam.push(scp_11);
				result_scp.arrItemintparam.push(scp_12);
				result_scp.arrItemintparam.push(scp_13);
				
				result_scp.callbacktype = 2;
				
				this.SCCallBack(result_scp);*/
			}
...
//			}
			XuanHuangJiangLi.instance(_sipl,_callbacktype).open();
		}
