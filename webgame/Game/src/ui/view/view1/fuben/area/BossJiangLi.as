package ui.view.view1.fuben.area
{
	...
	public class BossJiangLi extends UIWindow
	{
		...
		public function BossJiangLi(value:Vector.<StructIntParamList2>,_callbacktype:int)
		{
			sipl=value;
		...
		private static var _instance:BossJiangLi=null;
		
		public static function instance(value:Vector.<StructIntParamList2>,_callbacktype:int):BossJiangLi
		{
			if (null == _instance)
			{
				_instance=new BossJiangLi(value,_callbacktype);
			}
			else
			{
				sipl=value;
...
//			sprite["uil"].source=itemData.icon;
		...
		{
			BossJiangLi.instance(_sipl,_callbacktype).open();
		}
