package ui.view.view4.yunying
{
	 ...
	 * 
	 */
	public class HongFuQiTian
	{
		private static var m_instance:HongFuQiTian;
		private var mc:MovieClip;
		public function HongFuQiTian()
		{
		}
		public static function getInstance():HongFuQiTian
		{
			if (null == m_instance)
			{
				m_instance=new HongFuQiTian();
			}
