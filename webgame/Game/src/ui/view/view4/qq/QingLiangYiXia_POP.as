package view.view4.qq
{
	...
	public class QingLiangYiXia_POP extends UIWindow
	{
		private static var m_instance:QingLiangYiXia_POP;
		
		public function QingLiangYiXia_POP()
		{
			super(getLink(WindowName.pop_wenxintishi));
		}
		
		public static function getInstance():QingLiangYiXia_POP
		{
			if (null == m_instance)
			{
				m_instance= new QingLiangYiXia_POP();
			}
		...
		override protected function init():void
		{
			...
			mc['tf'].htmlText = Lang.getLabelArr("QQ_QingLiangYiXia_POP")[m_tipType];
