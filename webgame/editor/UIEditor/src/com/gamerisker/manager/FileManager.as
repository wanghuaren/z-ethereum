	...
	public class FileManager
	{
		...
		private static function OnOpenXMLFile(event:FileListEvent):void
		{
			...
			for (var i:int=0; i < total; ++i)
			{
				...
				editor=ComponentManager.setComponentByXML(componentXML, MouseManager.AddTouch, Define.Scene_Edit.OnTouchDownClick, Define.Scene_Edit.OnTouchMoveComponent);
				textStream.close();
			}
